...
export function FloatingContact() {
  return (
    <div className="fixed bottom-6 right-4 md:right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        <span className="w-10 h-10 bg-[#C8A45D] rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-white group-hover:text-[#C8A45D] transition-colors">

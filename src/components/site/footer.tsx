      ...
      <div className="max-w-[90rem] mx-auto">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-8 mb-12 md:mb-16">
          ...
          <div className="flex flex-col text-left">
            ...
            <p className="text-[10px] md:text-sm leading-relaxed md:leading-loose text-foreground/70 font-medium">
              Neduvelil H<br />
              Mutholapuram po<br />
              Elanji. Ernakulam.
            </p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
               ...
               <a href="#" className="w-6 h-6 md:w-8 md:h-8 flex items-center justify-center rounded-full bg-transparent hover:bg-foreground/5 transition-colors border border-foreground/20 text-foreground/80 hover:text-[#C8A45D] hover:border-[#C8A45D]">
                 <MessageCircle className="w-3 h-3 md:w-4 md:h-4" /> {/* WhatsApp fallback */}
               </a>
               <a href="#" className="w-6 h-6 md:w-8 md:h-8 flex items-center justify-center rounded-full bg-transparent hover:bg-foreground/5 transition-colors border border-foreground/20 text-foreground/80 hover:text-[#C8A45D] hover:border-[#C8A45D]">
          ...
          <div className="flex flex-col items-end text-right">
            ...
            <div className="space-y-2 md:space-y-3 flex flex-col items-end">
              <a href="tel:+918075931749" className="flex items-center gap-1 md:gap-3 text-[10px] md:text-sm text-foreground/70 hover:text-[#C8A45D] transition-colors font-medium">
                <Phone className="w-3 h-3 md:w-4 md:h-4 hidden sm:block" />
                <span>8075931749</span>
              </a>
              <a href="tel:+919400759169" className="flex items-center gap-1 md:gap-3 text-[10px] md:text-sm text-foreground/70 hover:text-[#C8A45D] transition-colors font-medium">
                <Phone className="w-3 h-3 md:w-4 md:h-4 hidden sm:block" />
                <span>9400759169</span>
              </a>
              <a href="mailto:jismariajl@gmail.com" className="flex items-center gap-1 md:gap-3 text-[10px] md:text-sm text-foreground/70 hover:text-[#C8A45D] transition-colors font-medium mt-1 md:mt-2">
                <Mail className="w-3 h-3 md:w-4 md:h-4 hidden sm:block" />
                <span className="break-all">jismariajl@gmail.com</span>
              </a>
            </div>
          </div>
        </div>

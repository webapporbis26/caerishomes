          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="step-content relative z-10 pl-6 md:pl-10 pb-12">
                ...
                <h3 className="font-display text-3xl md:text-4xl lg:text-5xl mb-4 text-foreground">
                  {s.t}
                </h3>
                <p className="text-foreground/60 text-lg md:text-xl max-w-md leading-relaxed">
                  {s.d}
                </p>
              </div>
            </div>

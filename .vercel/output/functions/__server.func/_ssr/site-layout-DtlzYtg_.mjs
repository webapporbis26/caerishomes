...
//#region node_modules/.nitro/vite/services/ssr/assets/site-layout-DtlzYtg_.js
...
function Footer() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		className: "bg-background text-foreground relative pt-12 pb-8 px-4 sm:px-8 md:px-12",

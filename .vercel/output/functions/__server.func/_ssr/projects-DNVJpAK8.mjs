...
import { B as ArrowRight, D as Globe, H as House, N as Clock, S as HeartHandshake, T as Handshake, b as Key, d as Phone, f as PencilRuler, g as MapPin, p as PenTool, r as Users, s as ShieldCheck, u as Play, w as HardHat, x as Heart } from "../_libs/lucide-react.mjs";
import { a as SiteLayout, c as testimonials, s as projects } from "./site-layout-DqrmCT8E.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/projects-DNVJpAK8.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[#111111]/70 md:bg-transparent z-10" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-y-0 left-0 w-full md:w-3/4 bg-gradient-to-r from-[#111111] via-[#111111]/90 to-transparent z-10 hidden md:block" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "relative z-20 w-full max-w-[90rem] mx-auto px-4 sm:px-8 md:px-12 xl:px-20 mt-24 md:mt-32",
...
function ProjectsStats() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			"data-reveal": true,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 md:divide-x divide-border/10",
